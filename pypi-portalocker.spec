...
Source0  : https://files.pythonhosted.org/packages/d5/2c/b565d42be77be6e642e9c193930258f25660a93900caca07c37ec107dd01/portalocker-2.10.0.tar.gz
...
%prep
%setup -q -n portalocker-2.10.0
cd %{_builddir}/portalocker-2.10.0
pushd ..
cp -a portalocker-2.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719250004
